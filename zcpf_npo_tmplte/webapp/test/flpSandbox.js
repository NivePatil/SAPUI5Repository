		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non-PO Template",
									"targetURL": "#comslbcpfonlinenonpozcpfnpotmplte-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comslbcpfonlinenonpozcpfnpotmplte-display": {
								"semanticObject": "comslbcpfonlinenonpozcpfnpotmplte",
								"action": "display",
								"description": "Non-PO Template Fiori application.",
								"title": "Non-PO Template",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.slb.cpf.online.nonpo.zcpfnpotmplte",
									"url": sap.ui.require.toUrl("com/slb/cpf/online/nonpo/zcpfnpotmplte")
								}
							}
						}
					}
