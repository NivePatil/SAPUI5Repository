		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "LH Dashboard",
									"targetURL": "#comslbsuplhshipmentmonitorzsuplhshpdsh-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comslbsuplhshipmentmonitorzsuplhshpdsh-display": {
								"semanticObject": "comslbsuplhshipmentmonitorzsuplhshpdsh",
								"action": "display",
								"description": "LH Dashboard",
								"title": "LH Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.slb.sup.lh.shipment.monitor.zsuplhshpdsh",
									"url": sap.ui.require.toUrl("com/slb/sup/lh/shipment/monitor/zsuplhshpdsh")
								}
							}
						}
					}
