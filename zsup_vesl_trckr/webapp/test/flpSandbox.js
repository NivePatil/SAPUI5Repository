		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comslbsupvesseltrackerzsupvesltrckr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comslbsupvesseltrackerzsupvesltrckr-display": {
								"semanticObject": "comslbsupvesseltrackerzsupvesltrckr",
								"action": "display",
								"description": "Vessel Tracker",
								"title": "Vessel Tracker",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.slb.sup.vessel.tracker.zsupvesltrckr",
									"url": sap.ui.require.toUrl("com/slb/sup/vessel/tracker/zsupvesltrckr")
								}
							}
						}
					}
